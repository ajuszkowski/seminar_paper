...
% 12. Adverb in wrong place\\Adverbs can only occur in three different positions in an English sentence:\\1) After the verb "to be"\\2) Before the main verb (predikaattiverbi)\\3) Between the auxiliary verb (apuverbi) and the main verb.
