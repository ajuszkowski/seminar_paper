...
\begin{lstlisting}[language=isabelle, caption={Definition of Peano's natural numbers type \texttt{nat} in Isabelle}]
datatype nat = 
    zero ("0") |
    Suc nat
\end{lstlisting}
&
\begin{lstlisting}[language=coq, caption={Definition of Peano's natural numbers type \texttt{nat} in Coq}]
Inductive nat : Type :=
  | O : nat
  | S : nat -> nat.
\end{lstlisting}
