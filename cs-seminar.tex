...
% 9., 11., 13. Determiners: new or generic info --> a(n)\\This noun/noun phrase is new or unknown information and should signalled with the indefinite article a or an, if the noun is countable, or without an article, if the noun is uncountable.\\The indefinite article is also used in general references, i.e., the word refers to any member of a group.\\Examples\\I need a pen (Any pen will do as long as it works).\An mp3-player is a device ...
