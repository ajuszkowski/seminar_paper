...
% 9., 11., 13, 15. Determiners: new or generic info --> a(n)\\This noun/noun phrase is new or unknown information and should signalled with the indefinite article a or an, if the noun is countable, or without an article, if the noun is uncountable.\\The indefinite article is also used in general references, i.e., the word refers to any member of a group.\\Examples\\I need a pen (Any pen will do as long as it works).\An mp3-player is a device ...
...
% 12., 22. Adverb in wrong place\\Adverbs can only occur in three different positions in an English sentence:\\1) After the verb "to be"\\2) Before the main verb (predikaattiverbi)\\3) Between the auxiliary verb (apuverbi) and the main verb.
...
% 14., 19., 24. Delete this text\\Academic writing aims to be concise and clear. Delete this text because it is not needed.
...
% 17. Too informal choice of adjectives \\You have the right meaning but the wrong word. Academic English requires a more formal adjective in this case. Choose a more formal form derived from French or Latin rather than the informal equivalent from spoken English.
% 18. Incorrect verb tense \\This is the wrong verb tense for this text. See also https://owl.english.purdue.edu/owl/resource/601/01/
% 20. This text is too similar with the original text. Rewrite it in your own words or use direct quotes to indicate identical wording.\\When you cite sources, you need to  use quotations, paraphrasing and summarizing. Careless use on identical  wording or even sentence structures can be interpreted as plagiarism, and you should use your own words as much as possible to avoid this.
% 23. Why quotes are used here? Earlier you introduced new concepts using italics, which works well.
...
% 27. Generic plural\\To signal that you are not referring to a particular instance of a thing, but rather talking in a "general way" about it, use the plural form without the definite article the (as well as without indefinite article a).\\Examples\\∅ ComputerS have changed the way we work. (Generalization)\\The Computer is broken again. (A particular computer, my work computer)
% 29. Enclose parenthetical information and appositives within commas.
...
% 30. Listing section in article structure\\Specifying the article structure and listing the sections is a useful form of metatext. However, it is not necessary make it more complicated and artificially interesting by adding variation into sentence structures and subjects. \\To keep such paragraph concise and systematic, write it as follows:\\This paper is organized/structured as follows. (There are other variations to this sentence).\\Section 2 <a reporting verb in present tense, e.g., discusses>\Section 3 . . . \\Section 4 . . . \\. . . and so on\\This approach also helps to avoid passive voice and end-verbs. For example phrases and expressions
...
Although in most cases formal models work efficiently, in previous century mathematics experienced deep fundamental crisis caused by the need for a formal definition of the very basis of mathematics. That time many paradoxes in some mathematics have been discovered, so, in 1920s, the three main confrontation schools appeared:
