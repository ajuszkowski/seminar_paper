...
One of the useful applications of theory of logic as is the Automated theorem proving. This is a set of techniques that allow one to verify some mathematical expressions using machine. Although, it can be also used to prove some properties of a system, for example to prove the security properties for a software or an algorithm. Also, Automated theorem proving is a essential part of the Artificial Intelligence theory, which became highly evolving these days. In this paper, we describe bases of logic and automated deduction theory and compare properties of two widespread tools for Automated theorem proving: Coq [1] and Isabelle [2].
