...
%Isabelle/HOL (from http://isabelle.in.tum.de/dist/Isabelle2017/doc/prog-prove.pdf)
%- позволяет работать с типизированным функциональным языком прог-ия (в кавычках, встроенный)
%	- base types, s.a. bool, nat N, int Z
%	- type constructors, s.a. list
%	- function types (e.g. f :: 'a => 'b)
%	- type variables (in ML style: 'a, 'b)
%- Terms are formed as in functional programming by applying functions to
%arguments
%- HOL also supports some basic constructs from functional programming:
%	- (if b then t1 else t2)
%	- (let x = t in u)
%	- (case t of pat1 ⇒ t1 | . . . | pat n ⇒ t n)
%	- Terms may also contain λ-abstractions
%- Formulas are terms of type bool
%	- connectives: ¬, ∧, ∨, −→
%- Equality is available in the form of the infix function = of type 'a ⇒ 'a ⇒ bool
...
%inductive types:
%	- Note that inductive involves internal proofs of monotonicity of
%	the recursive predicate specification, and the resulting introduction,
%	elimination, induction rules. (http://plmms09.cs.tamu.edu/proceedings.pdf, page 14)
...
%Termination: "The method lexicographic_order is the default method for termination proofs." https://isabelle.in.tum.de/doc/functions.pdf
